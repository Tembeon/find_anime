...
ThemeData themeData() {
  ...
  return ThemeData(
    ...
    textButtonTheme: TextButtonThemeData(
      ...
      textStyle: const TextStyle(fontWeight: semiBold),
    ...
    inputDecorationTheme: const InputDecorationTheme(
      ...
      errorStyle: TextStyle(color: Colors.red, fontWeight: semiBold),
...
ThemeData darkThemeData() {
  ...
  return ThemeData.dark().copyWith(
    ...
    inputDecorationTheme: const InputDecorationTheme(
      alignLabelWithHint: true,
      errorStyle: TextStyle(color: Colors.redAccent, fontWeight: semiBold),
      labelStyle: TextStyle(fontWeight: semiBold),
      hintStyle: TextStyle(fontWeight: semiBold),
      contentPadding: EdgeInsets.symmetric(horizontal: 20, vertical: 15),
      border: OutlineInputBorder(
